...
@if(isset($meta_tags))
<meta name="title" content="{{$meta_tags['title'] ?? 'ruangnamu.com'}}" />
<meta name="description" content="{{$meta_tags['description'] ?? 'Buat undangan digitalmu sendiri!'}}" />
<meta name="keywords" lan="id" content="{{$meta_tags['keywords'] ?? 'ruangnamu.com, undangan digital, undangan pernikahan'}}" />
<meta property="og:title" content="{{$meta_tags['title'] ?? 'ruangnamu.com'}}" />
...
<meta name="twitter:title" content="{{$meta_tags['title'] ?? 'ruangnamu.com'}}"/>
<meta name="twitter:image" content="{{ $meta_tags['image'] ?? asset('images/assets/cover.jpg') }}" />

<title>{{$meta_tags['title'] ?? 'ruangnamu.com'}}</title>
@endif
